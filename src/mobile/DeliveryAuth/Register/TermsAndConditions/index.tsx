...
const TermsConditionsDeliveryPopUp = (props: any) => {
	...
	return (
		<div className={classes.TermsConditionsPopUpMain}>
			<div className={classes.TermsConditions}>
				...
				<span onClick={(e) => setVisibility(!visibility)} className={classes.TandCText}>
...
export default TermsConditionsDeliveryPopUp;
