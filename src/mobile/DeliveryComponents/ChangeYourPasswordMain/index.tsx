...
import { actionChangePasswordApiCall, actionDeliveryChangePasswordApiCall } from "../../store/actions";
import { useDispatch } from "react-redux";
import { useSelector } from "react-redux";
import { RootState } from "../../store/reducers/rootReducers";
import LoadingAnimation from "../../../pages/AnimationLoader/LoadingAnimation";

const DelivertChangeYourPasswordMain = () => {
  ...
  const handleOnClick = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    if (
      ...
      dispatch(actionDeliveryChangePasswordApiCall(body));
    }
  };
  return (
    <React.Fragment>
...
export default DelivertChangeYourPasswordMain;
